 ...
 create ()
{
    ...
    this.platforms.create(600, 410, 'ground');
    this.platforms.create(50, 260, 'ground');
    this.platforms.create(740, 230, 'ground');
 ...
 hitBomb (player, bomb)
{
    ...
    this.text2 = this.add.text(250, 250, 'Fin del Juego.', { font: "50px Arial Black", fill: "#fff" });
